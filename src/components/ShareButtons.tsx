...
export default function ShareButtons({ title }: { title: string }) {
  ...
  return (
    <div className="hidden sm:flex items-center gap-4 text-slate-400">
      ...
      <a href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(url)}`} target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors" title="Share on Facebook"><Facebook size={20} /></a>
      ...
      <a href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(url)}`} target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors" title="Share on LinkedIn"><Linkedin size={20} /></a>
